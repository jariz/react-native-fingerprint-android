...
export default NativeModules.FingerprintAndroid
...
//            DeviceEventEmitter.addListener('onFingerprintAuthenticationHelp', warningCallback);
//        }
//
//        let err;
//        try {
...
//            DeviceEventEmitter.removeAllListeners("onFingerprintAuthenticationHelp");
//
//            if(err) {
//                throw err
//            }
